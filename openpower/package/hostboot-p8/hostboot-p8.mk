...
ifeq ($(BR2_HOSTBOOT_P8_USE_ALTERNATE_TOOLCHAIN),y)
HOSTBOOT_P8_TARGET_CROSS = $(HOST_DIR)/$(ALTERNATE_TOOLCHAIN_DIR)/bin/$(GNU_TARGET_NAME)-
HOSTBOOT_P8_BINUTILS_DIR = $(HOST_ALTERNATE_BINUTILS_DIR)
HOSTBOOT_P8_DEPENDENCIES = host-alternate-toolchain
else
...
HOSTBOOT_P8_ENV_VARS=$(TARGET_MAKE_ENV) \
    ...
    HOST_BINUTILS_DIR=$(HOSTBOOT_P8_BINUTILS_DIR) \
