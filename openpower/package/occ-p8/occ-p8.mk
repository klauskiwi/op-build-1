...
ifeq ($(BR2_OCC_P8_USE_ALTERNATE_TOOLCHAIN),y)
OCC_P8_TARGET_CROSS = $(HOST_DIR)/$(ALTERNATE_TOOLCHAIN_DIR)/bin/$(GNU_TARGET_NAME)-
OCC_P8_DEPENDENCIES += host-alternate-toolchain
else
...
define OCC_P8_BUILD_CMDS
        cd $(@D)/src && \
        make POREPATH=$(P8_PORE_BINUTILS_BIN)/bin/ OCC_OP_BUILD=1 CROSS_PREFIX=$(OCC_P8_TARGET_CROSS) all && \
        make tracehash && \
        make combineImage
endef
